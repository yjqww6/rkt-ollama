...
(define-llama llama_model_load_from_file (_fun _string _llama_model_params -> _pointer))
(define-llama llama_model_free (_fun _pointer -> _void))
...
(define-llama llama_model_get_vocab (_fun _pointer -> _pointer))
...
(define-llama llama_vocab_n_tokens (_fun _pointer -> _uint32))
